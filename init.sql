...
INSERT INTO `sys_user` (`id`, `username`, `full_name`, `hashed_password`, `role`, `department`, `is_active`, `is_superuser`) VALUES
  (1, 'admin',  '信息维护',   '$2b$12$eb./yT6rZ1TxTSj6JYdyfe8OCvHTB3NY4Op2kwDYHqqKLls/N43nS', 'info_maintainer',   '信息中心',   1, 1),
...
INSERT INTO `biz_contract`
  ...
  (1, 'HT-2026-001', '2026年度教材印制采购合同', '山东出版供应链管理有限公司', '齐鲁印刷有限公司',   1800000.00, '2026-01-15', '年度框架合同', 'payment',  '业务部', '齐鲁印刷有限公司',   '印刷采购', 'draft', 0, 2),
  (2, 'HT-2026-002', '数字出版平台技术服务合同', '山东出版供应链管理有限公司', '泉城软件科技有限公司', 600000.00, '2026-02-20', '含一年运维',   'payment',  '业务部', '泉城软件科技有限公司', '技术服务', 'draft', 0, 2),
  (3, 'HT-2026-003', '仓储物流外包服务合同',     '山东出版供应链管理有限公司', '鲁运物流股份有限公司',  450000.00, NULL,         '草拟中',       'business', '业务部', '鲁运物流股份有限公司', '物流仓储', 'draft', 0, 2);
