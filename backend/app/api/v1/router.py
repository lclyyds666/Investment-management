...
from app.api.v1.endpoints import (
    approval, auth, channel, contract, customer, health, invoice, knowledge, operation, user,
)
...
api_router.include_router(approval.router, prefix="/approval-forms", tags=["审批中心"])
