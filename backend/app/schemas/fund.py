...
class FundTransactionInput(BaseModel):
...
class FundTransactionCreate(FundTransactionInput):
    pass


class FundTransactionUpdate(FundTransactionInput):
    pass
...
class FundTransactionOut(FundTransactionInput):
